...
2. Run `docker-compose -p phonewave up -d bot database` on the project root directory (where the `docker-compose.yml` file is present). This will start the bot and database services in detached mode.
